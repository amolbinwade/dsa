...
class RandomizedSet:
    ...
    def __init__(self):
        # Stores values to allow O(1) random access by index
        self.list = []
        # Stores {value: index} to allow O(1) lookup
        self.map = {}
    ...
    def insert(self, val: int) -> bool:
        ...
        # Add to map with its future index (current length of list)
    ...
    def remove(self, val: int) -> bool:
        ...
        # 2. Swap the element to remove with the last element in the list
